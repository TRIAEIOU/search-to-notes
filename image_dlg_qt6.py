...
class Ui_image_dlg(object):
    def setupUi(self, image_dlg):
        ...
        image_dlg.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        image_dlg.resize(760, 659)
        image_dlg.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedStates))
